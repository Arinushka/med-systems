...
import { couldBeProductNameValue, indicatorLooksLikeProductNameColumn, looksLikeAuxValueForFirstColumnProduct, } from './productName';
...
export async function extractRowsFromFile(params) {
    ...
    if (lower.endsWith('.xlsx') || lower.endsWith('.xls')) {
        ...
        for (const r of rowsAOA) {
            ...
            if (!valueAcceptableForRow(rawInd, rawVal))
                continue;
