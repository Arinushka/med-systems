...
export function readMatchPipelineConfig() {
    return {
...
export function createMatchingRuntime() {
    ...
    const pipeline = new MatchPipeline(config, embeddings, vectors, retriever, lexicalMatcher, semanticMatcher, structuralMatcher, exactFieldMatcher, scorer, reranker, explanationBuilder);
